...
create table public.customer_events (
  ...
  type text not null check (type in ('reservation_created', 'reservation_confirmed', 'visit_completed', 'note_added', 'task_created', 'campaign_sent', 'wallet_topup', 'points_earned')),
  title text not null,
  description text,
